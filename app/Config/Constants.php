 ...
 * 
 * Git Integration with dynamic config
 */
$_check_env_file = file_exists(FCPATH.'\.env');
...
defined('DYNAMIC_DB_PASSWORD') || define('DYNAMIC_DB_PASSWORD',$db_password);
defined('DYNAMIC_DB_NAME') || define('DYNAMIC_DB_NAME',$db_name);
